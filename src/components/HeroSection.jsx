      ...
      <section className="px-4 md:px-6 py-13 max-w-4xl mx-auto">
        <div className="bg-white rounded-sm shadow-lg flex flex-col items-center justify-center text-center pt-16 pb-12 px-8">
          ...
          <p className="text-2xl text-gray-600 max-w-xl mb-2 font-normal">
            Software Engineering Student, passionate about building clean and
          ...
          <div className="pt-4 grid grid-cols-3 gap-4">
            ...
            <a
              href="https://leetcode.com/u/daniel_3003/"
              className="flex flex-col items-center text-gray-400 hover:text-orange-400 duration-500"
            >
              <svg
                fill="currentColor"
                width="32"
          ...
          <a href="#projects" className="mt-2 hover:text-red-400 duration-500">
            View my work.
          </a>
        </div>
      </section>
